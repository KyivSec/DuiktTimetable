...
import com.kyivsec.duikt_timetable.data.local.CachedScheduleDayEntity
import com.kyivsec.duikt_timetable.data.local.SemesterSyncEntity
import com.kyivsec.duikt_timetable.data.local.CourseEntity
import com.kyivsec.duikt_timetable.data.local.FacultyEntity
import com.kyivsec.duikt_timetable.data.local.GroupEntity
import com.kyivsec.duikt_timetable.data.local.ChairEntity
import com.kyivsec.duikt_timetable.data.local.TeacherEntity
import com.kyivsec.duikt_timetable.data.local.StudentEntity
import com.kyivsec.duikt_timetable.data.local.TimetableDatabase
import com.kyivsec.duikt_timetable.data.local.toDomain
import com.kyivsec.duikt_timetable.data.local.toEntity
import com.kyivsec.duikt_timetable.data.remote.DuiktLessonMapper
import com.kyivsec.duikt_timetable.data.remote.DuiktScheduleClient
import com.kyivsec.duikt_timetable.data.remote.HttpStatusException
import com.kyivsec.duikt_timetable.data.remote.RejectedSessionException
import com.kyivsec.duikt_timetable.data.remote.SourceFormatException
...
class RoomTeacherDirectoryRepository(
    private val database: TimetableDatabase,
    private val client: com.kyivsec.duikt_timetable.data.remote.DirectoryClient,
    private val clock: Clock = Clock.systemDefaultZone(),
