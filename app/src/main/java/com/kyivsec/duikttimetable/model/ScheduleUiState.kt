...
data class ScheduleUiState(
    ...
    val activeOwner: TimetableOwner? = null,
    val activeOccupation: Occupation? = null,
    val needsOccupationSelection: Boolean = false,
    val needsGroupSelection: Boolean = false,
    val needsTeacherSelection: Boolean = false,
    val needsStudentSelection: Boolean = false,
    ...
    val chairs: List<ChairInfo> = emptyList(),
    val directoryTeachers: List<TeacherInfo> = emptyList(),
    val draftChairId: Long? = null,
    val draftTeacher: TeacherInfo? = null,
    val isTeachersLoading: Boolean = false,
    val directoryStudents: List<StudentInfo> = emptyList(),
    val draftStudent: StudentInfo? = null,
