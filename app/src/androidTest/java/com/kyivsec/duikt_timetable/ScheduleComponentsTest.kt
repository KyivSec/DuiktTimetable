...
import com.kyivsec.duikt_timetable.ui.component.LessonCard
import com.kyivsec.duikt_timetable.ui.component.WeekSchedule
import com.kyivsec.duikt_timetable.ui.component.WeekDayCard
...
class ScheduleComponentsTest {
    ...
    @Test fun swipingWeekUpdatesRangeWithoutWaitingForSettlementState() {
        ...
        fun week(start: LocalDate, number: Int) = com.kyivsec.duikt_timetable.model.ScheduleWeek(
